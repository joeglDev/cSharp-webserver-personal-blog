...
WHERE NOT EXISTS (
    ...
    public string SelectAllBlogPosts = "SELECT * FROM blogposts b LEFT JOIN server_storage_images i ON b.Id = i.blogpost_id;";
    ...
    public string ServerStorageDeleteImage = "DELETE FROM server_storage_images WHERE blogpost_id = :blogpost_id;";
